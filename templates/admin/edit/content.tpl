<!-- Apache::Controller::Interface Edit Template -->
<!-- v1.0 JPRO 24/01/2006                        -->


<form action="$G_LOCATION/$G_LEVEL/edit/$ORG_NAME/$ORG_SITE" method="post">
	<input type="hidden" name="next_page_edit" value="$G_LOCATION/$G_LEVEL/" />

	<input type="hidden" name="org_name" value="$ORG_NAME" />
	<input type="hidden" name="org_site" value="$ORG_SITE" />
	...
	<div class="edit-row">
		<div>&nbsp;</div>
		<input class="edit-row-submit" type="submit" name="CMD_edit" value="Edit Module" />
	</div>
</form>
